...
urlpatterns = [
    ...
    path('create/<int:n_players>/<int:is_ranked_int>/<int:is_private_int>/<float:latitude>/<float:longitude>/<int:sport_id>/<int:admin_id>', CreateLobbyView.as_view(), name = 'create_lobby_view'),
